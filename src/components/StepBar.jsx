...
const steps = [
  { id: 1, icon: FileUp, label: 'Upload', gradient: 'linear-gradient(135deg, #1e40af 0%, #3b82f6 100%)', glowColor: 'rgba(30, 64, 175, 0.4)' },
  { id: 2, icon: Lock, label: 'Anonymize', gradient: 'linear-gradient(135deg, #1f2937 0%, #374151 100%)', glowColor: 'rgba(31, 41, 55, 0.4)' },
  { id: 3, icon: Eye, label: 'Blockchain', gradient: 'linear-gradient(135deg, #0369a1 0%, #0ea5e9 100%)', glowColor: 'rgba(3, 105, 161, 0.4)' },
  { id: 4, icon: Sparkles, label: 'AI Analyze', gradient: 'linear-gradient(135deg, #1e3a8a 0%, #2563eb 100%)', glowColor: 'rgba(30, 58, 138, 0.4)' },
  { id: 5, icon: Trophy, label: 'Certificate', gradient: 'linear-gradient(135deg, #172554 0%, #1e40af 100%)', glowColor: 'rgba(23, 37, 84, 0.4)' },
];
            ...
            <div style={{
              ...
              <div style={{
                ...
                <IconComponent 
                  size={28}
                  strokeWidth={2.2}
                  color={isDone ? '#60a5fa' : isActive ? '#60a5fa' : '#60a5fa'} 
                  style={{
